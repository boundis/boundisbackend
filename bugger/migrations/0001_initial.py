...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bug'
        db.create_table(u'bugger_bug', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('summary', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('bug_description', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bug_work_assigned_to', null=True, to=orm['auth.User'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bug_created_by', to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'bugger', ['Bug'])


    def backwards(self, orm):
        # Deleting model 'Bug'
        db.delete_table(u'bugger_bug')
