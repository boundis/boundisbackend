...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('user_profile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=8))

    def backwards(self, orm):

        # Changing field 'UserProfile.gender'
        db.alter_column('user_profile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
    ...
    models = {
        ...
        u'user_profiles.userprofile': {
            ...
            'gender': ('django.db.models.fields.CharField', [], {'default': "'male'", 'max_length': '8'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
