...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facility.facility_type'
        db.alter_column(u'locations_facility', 'facility_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sports.Facility_type']))

    def backwards(self, orm):

        # Changing field 'Facility.facility_type'
        db.alter_column(u'locations_facility', 'facility_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sports.Facility_type'], null=True))
