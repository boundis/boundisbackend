...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facility.surface'
        db.alter_column(u'locations_facility', 'surface_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sports.Surface_type']))

    def backwards(self, orm):

        # Changing field 'Facility.surface'
        db.alter_column(u'locations_facility', 'surface_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sports.Surface']))
