...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venue.summary'
        db.add_column(u'locations_venue', 'summary',
                      self.gf('django.db.models.fields.TextField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venue.summary'
        db.delete_column(u'locations_venue', 'summary')
